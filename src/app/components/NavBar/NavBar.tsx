		...
		<>
			...
			>
				<ul>
					...
					<li>
						<Link href="/logs_v2" className={pathname.includes("/logs_v2") ? styles.muted : undefined}>
							logs
						</Link>
					</li>
					<li>
						<Link href="/artefacts" className={pathname.includes("/artefacts") ? styles.muted : undefined}>
							artefacts
						</Link>
					</li>
					<li>
						<Link href="/about" className={pathname.includes("/about") ? styles.muted : undefined}>
							about
						</Link>
					</li>
				</ul>
