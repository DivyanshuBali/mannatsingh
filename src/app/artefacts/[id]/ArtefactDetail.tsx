	...
	return (
		<div className={styles.content}>
			<div className={styles.imageNav}>
				...
				<div className={styles.imageFrame} onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
			...
			{item.images.length > 1 && (
				<div className={styles.dots}>
					{item.images.map((_, i) => (
						<span key={item.images[i]} className={`${styles.dot} ${i === imageIndex ? styles.dotActive : ""}`} />
					))}
				</div>
			)}
